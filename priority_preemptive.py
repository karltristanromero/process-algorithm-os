...
class PriorityPreemptive(SchedulerBase):
    """Preemptive Priority Scheduler implementation."""
    ...
    def run_priority_preemptive(self):
        ...
        while completed < n:
            ...
            if available:
                ...
                if execution_segments and execution_segments[-1][0] == idx:
                    execution_segments[-1] = (idx, execution_segments[-1][1], time + 1)
                else:
                    execution_segments.append((idx, time, time + 1))
                time += 1
        ...
        self.animate_execution_loop(execution_segments, processes)